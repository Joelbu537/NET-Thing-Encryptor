...
Diese Änderung verfeinert den nach M8 ausgelieferten Avalonia-Client bis einschließlich Version 4.0.0. Sie ist kein Beginn von M9. Ziel ist eine vertrautere Windows-Bedienung, ohne Android in ein ungeeignetes Desktop-Raster zu zwingen.

## Windows-Vertrag

Die Hauptansicht besteht aus vier kompakten Bereichen:

1. Symbolleiste mit Zurück, Import, neuem Ordner und Aktualisieren, dem aktuellen Tresorpfad sowie Stammverzeichnis, Einstellungen und Sperren
2. Suche
...
Eingabe in das Suchfeld kann mit Enter ausgeführt werden. Der Rücksetzknopf liegt innerhalb des Suchfelds. Die Statuszeile zeigt nach dem Entsperren keine redundante Meldung an; spätere Aktions- und Fehlermeldungen können weiterhin dort erscheinen.
